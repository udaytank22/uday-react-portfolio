import buspass from '../src/assets/images/buspass.png';

const logotext = "Uday";
const meta = {
    title: "Uday Tank",
    description: "I’m Uday Tank data scientist _ Full stack devloper,currently working in Berlin",
};
...
const services = [{
    title: "Web Designing",
    description: "I am a fresher web Designer with the basic knowlage of HTML, CSS also a good knowlage of framework such as a Bootstrape.",
},
{
    title: "Figma Design",
    description: "I am a fresher UI UX Designer with the good knowlage of Designing software like figma, photoshope and adobe xd.",
},
{
    title: "React Software Development",
    description: "I am a fresher frontend developer with the good knowlage of React Native and also a good knowlage of implimating smoothless api and basic knowalge of redux.",
},
];
...
const dataportfolio = [
    {
        ...
        description: " The app allows users to efficiently manage their business operations.",
...
This project, built using the Django framework, is designed to streamline business operations and improve efficiency.`,
    ...
    },
    {
        ...
        description: "comprehensive billing system specifically for flower businesses.",
